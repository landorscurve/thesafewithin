...
<img src="/Logo.svg" alt="The Safe Within" style={{ width:'160px', margin:'0 auto 32px', display:'block', opacity:0.95 }} />        <h1 style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'clamp(26px,5vw,36px)', fontWeight:400, color:C.text, letterSpacing:'-0.02em', lineHeight:1.3, margin:'0 0 18px' }}>
